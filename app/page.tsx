...
export default function HomePage() {
  return (
    <main className={`${jetBrainsMono.variable} ${vt323.variable} min-h-screen flex flex-col text-[#E4DDC4] p-2 bg-[url('noise.svg')] bg-repeat`}>
      <h1 className="text-4xl font-mono font-normal uppercase mb-8">
        Invitide
      </h1>
        ...
        <div className="flex flex-row justify-between items-start">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 ml-33">
              <button className="border border-[#E4DDC4] px-4 py-2 uppercase">Create Event</button>
              <button className="border border-[#E4DDC4] px-4 py-2 uppercase">Find Event</button>
            </div>
          </div>
          <div className="flex flex-col items-center mr-10 ml-20 mt-20">
