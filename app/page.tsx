      ...
      <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 items-center justify-center flex-1 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col text-center lg:text-left max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <Link
              href="/find-events"
              className="border-[4px] text-lg sm:text-xl md:text-2xl border-[#E4DDC4] px-4 sm:px-6 py-2 uppercase hover:bg-[#E4DDC4] hover:text-[#1F1F1F] transition text-center"
            >
              Find Events
            </Link>
          </div>
